...
/** @internal */
const toReadableStream = self => toReadableStreamRuntime(self, Runtime.defaultRuntime);
/** @internal */
exports.toReadableStream = toReadableStream;
const toReadableStreamEffect = self => Effect.map(Effect.runtime(), runtime => toReadableStreamRuntime(self, runtime));
/** @internal */
exports.toReadableStreamEffect = toReadableStreamEffect;
const toReadableStreamRuntime = exports.toReadableStreamRuntime = /*#__PURE__*/(0, _Function.dual)(2, (self, runtime) => {
