...
var doNotation = /*#__PURE__*/_interopRequireWildcard( /*#__PURE__*/require("./doNotation.js"));
...
const gen = function () {
  ...
  return core.suspend(() => {
    ...
    const state = (0, _Utils.internalCall)(() => iterator.next());
    const run = state => {
      return state.done ? core.succeed(state.value) : core.flatMap((0, _Utils2.yieldWrapGet)(state.value), val => run((0, _Utils.internalCall)(() => iterator.next(val))));
    };
    return run(state);
  });
};
