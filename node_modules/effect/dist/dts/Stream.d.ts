 ...
 * @category destructors
 */
export declare const toReadableStream: <A, E>(self: Stream<A, E>) => ReadableStream<A>;
/**
 ...
 * @category destructors
 */
export declare const toReadableStreamEffect: <A, E, R>(self: Stream<A, E, R>) => Effect.Effect<ReadableStream<A>, never, R>;
/**
 ...
 * @since 3.1.0
 */
export declare const fromEventListener: <A = Event>(target: EventTarget, type: string, options?: boolean | Omit<AddEventListenerOptions, "signal">) => Stream<A>;
