...
export interface MetricApply {
    <Type, In, Out>(keyType: Type, unsafeUpdate: (input: In, extraTags: ReadonlyArray<MetricLabel.MetricLabel>) => void, unsafeValue: (extraTags: ReadonlyArray<MetricLabel.MetricLabel>) => Out): Metric<Type, In, Out>;
}
/**
 * @since 2.0.0
 */
 ...
 * @category getters
 */
export declare const snapshot: Effect.Effect<ReadonlyArray<MetricPair.MetricPair.Untyped>>;
/**
