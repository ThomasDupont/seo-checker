...
export declare namespace Config {
     ...
     * @category models
     */
    type Wrap<A> = [NonNullable<A>] extends [infer T] ? [T] extends [Function] ? Config<A> : [
        T
    ] extends [ReadonlyArray<infer _>] ? Config<A> : [
        T
 ...
 * @category constructors
 */
export declare const array: <A>(config: Config<A>, name?: string) => Config<ReadonlyArray<A>>;
/**
